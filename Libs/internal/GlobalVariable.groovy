...
public class GlobalVariable {
    ...
    static {
        def allVariables = [:]        
        allVariables.put('default', ['G_Timeout' : 10, 'G_NotificationMessage' : 'Your message has been sent. View message', 'G_AndroidApp' : 'androidapp/Sample.apk', 'G_ShortTimeOut' : 5])
